...
class PersonX(Dataset):

    def __init__(self, root, split_id=0, num_val=100, download=True):
        super(PersonX, self).__init__(root, split_id=split_id)
    ...
    def download(self):
        ...
        fpath = osp.join(raw_dir, 'personX456.zip')
        if osp.isfile(fpath):
        ...
        # Extract the file
        exdir = osp.join(raw_dir, 'personX456')
        ...
        meta = {'name': 'PersonX', 'shot': 'multiple', 'num_cameras': 3,
